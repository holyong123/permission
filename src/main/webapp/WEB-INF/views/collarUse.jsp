    ...
    <div class="col-sm-9">
        <div class="col-xs-12">
            <div class="table-header">
                已购买物品列表&nbsp;&nbsp;
<%--                <a class="green" href="#">--%>
<%--                    <i class="ace-icon fa fa-plus-circle orange bigger-130 goods-add"></i>--%>
<%--                </a>--%>
                <a class="red" href="#" style="margin-left:10px">
                    <i class="ace-icon fa fa-arrow-down orange bigger-130 goods-up"  onclick="beforeSubmit()"></i>
                </a>
    ...
    <form id="goodsForm">
        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid">
            ...
            <tr>
                ...
                <td><input type="text" name="name" id="goodsName" value="" class="text ui-widget-content ui-corner-all"></td>
            </tr>
...
<%--                    <input type="text" name="applicant" id="applicantName" value="" class="text ui-widget-content ui-corner-all">--%>
            ...
            <tr>
                <td><label for="goodsStatus">状态</label></td>
                <td>
...
<div id="dialog-excel-form" style="display: none;">
    <form id="excelForm" action="/test/export.json" method="post">
        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid">
