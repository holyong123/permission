    ...
    <form id="faultForm">
        <table class="table table-striped table-bordered table-hover dataTable no-footer" >
            ...
            <tr>
                ...
                <td>
                    <textarea name="faultSolution" id="faultSolution" class="text ui-widget-content ui-corner-all" rows="3" cols="25"></textarea>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="hidden" name="dealingPeople" id="people" />
                </td>
            </tr>
...
<script type="text/javascript">
    ...
    $(function(){
        let faultMap = {}; // 存储map格式故障信息
        let faultListTemplate = $("#faultListTemplate").html();
        ...
        function loadFaultList(){
            var url = "/fault/handingList.json";
        ...
        function renderFaultListAndPage(result,url){
            if (result.ret) {
                        ...
                        "bold": function() {
                            return function(text, render) {
                                ...
                                if (status == '待处理') {
                                    ...
                                    return "<span class='label label-sm label-warning'>处理中</span>";
                                } else {
                ...
                showMessage("获取故障列表", result.msg, false);
            }
