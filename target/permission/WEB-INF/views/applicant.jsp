    ...
    <form id="approvalForm">
        <table class="table table-striped table-bordered table-hover dataTable no-footer" >
            ...
            <tr>
                ...
                <input type="hidden" name="id" id="approvalId" style="outline: none"/>
                <td><input type="text" name="name" id="approvalName" class="text ui-widget-content ui-corner-all"  style="outline: none;"> </input></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="count" id="count" class="text ui-widget-content ui-corner-all" rows="3" cols="25" /></td>
            </tr>

            <tr>
                <td><label for="price">价格(/元)</label></td>
                <td>
                    <input type="text" name="price" id="price" class="text ui-widget-content ui-corner-all" rows="3" cols="25" />
                </td>
            </tr>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $(".approval-add").on('click',function () {
                ...
                $("#dialog-approval-form").dialog({
                    ...
                    open: function(event, ui) {
                        ...
                        if (targetApproval) {
                            ...
                            $("#price").val(targetApproval.price);
                        }
                    },
                    buttons : {
                        "修改": function(e) {
